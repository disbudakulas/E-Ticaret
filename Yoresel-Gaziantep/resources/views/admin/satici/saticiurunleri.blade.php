                            ...
                            <div class="x_content">
                                <div id="datatable-buttons_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                    <div class="dt-buttons btn-group pull-right">
                                        <a class="btn btn-default buttons-copy buttons-html5 btn-sm btn-primary" tabindex="0" aria-controls="datatable-buttons" href="{{ route('saticiurunduzenle') }}">
                                            <i class="fa fa-plus"></i><span> {{ __('saticiurunler.urunekle') }}</span>
                                        </a>
                                    </div>
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="column2">{{ __('saticiurunler.resim') }}</th>
                                            <th class="column3">{{ __('saticiurunler.urunadi') }}</th>
                                            <th class="column4">{{ __('saticiurunler.saticiunvan') }}</th>
                                            <th class="column5">{{ __('saticiurunler.fiyat') }}</th>
                                            <th class="column6">{{ __('saticiurunler.stok') }}</th>
                                            <th class="column7">{{ __('saticiurunler.durum') }}</th>
                                            <th class="column8"></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            @if($count > (($page-1)*10) && $count<=($page*10))
                                                <tr>
                                                    ...
                                                    <td class="column8" width="16%">
                                                        <a href="/saticiurunsil?id={{ $urun['id'] }}"><button type="button" class="btn btn-danger btn-sm">{{ __('saticiurunler.sil') }}</button></a>
                                                        <a href="/saticiurunduzenle?id={{ $urun['id'] }}"><button type="button" class="btn btn-primary btn-sm">{{ __('saticiurunler.duzenle') }}</button></a>
                                                    </td>
                                                </tr>
                                            @endif
                                            <?php $count++; ?>
