            ...
            <div class="row">
                ...
                <div class="right_col" >
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>{{ __('saticiurunler.urunduzenle') }}</h2>
                            ...
                            <div class="x_content">
                                <br />
                                <form action="{{ route('saticiurunresmiduzenle') }}" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="row text-center">
                                                ...
                                                <button type="button" class="btn btn-default" id="cancel-img" style="display: none;"><i class="fa fa-close"></i> {{ __('saticiurunler.kaldir') }}</button>
                                            </div>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title" id="getCroppedCanvasTitle">{{ __('saticiurunler.resimduzenle') }}</h4>
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-36 col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ __('saticiurunler.urunadi') }} <span class="required">*</span>
                                                </label>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ __('saticiurunler.kategori') }} <span class="required">*</span>
                                                </label>
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ __('saticiurunler.urunaciklama') }}
                                                </label>
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ __('saticiurunler.urundurumu') }} <span class="required">*</span>
                                                </label>
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-36 col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ __('saticiurunler.birim') }} <span class="required">*</span>
                                                </label>
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ __('saticiurunler.stok') }} <span class="required">*</span>
                                                </label>
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input name="stok" type="number" id="first-name" required="required" class="form-control col-md-7 col-xs-12" value="{{ $icerik->productNumber??null }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" >{{ __('saticiurunler.birimfiyati') }} <span class="required">*</span>
                                                </label>
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ __('saticiurunler.indirimturu') }}
                                                </label>
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ __('saticiurunler.indirim') }}
                                                </label>
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">{{ __('saticiurunler.kargoucreti') }} <span class="required">*</span>
                                                </label>
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12 col-md-offset-5">
                                                <a href="{{ route('saticiurunleri') }}" class="btn btn-primary">{{ __('saticiurunler.iptal') }}</a>
                                                <button type="submit" class="btn btn-success">{{ __('saticiurunler.urunresmiduzenle') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
