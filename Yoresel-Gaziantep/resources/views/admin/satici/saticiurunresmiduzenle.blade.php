            ...
            <div class="row">
                ...
                <div class="right_col" >
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <form action="{{ route('saticiurunresimekle') }}" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="dt-buttons btn-group pull-left">
                                            <a href="/saticiurunduzenle?id={{ $id }}" ><i class="fa fa-long-arrow-left fa-2x" style="border: 1px solid midnightblue;border-radius: 3px;padding-left: 5px;padding-right: 8px"></i></a>
                                        </div>
                                                ...
                                                @if($count > (($page-1)*10) && $count<=($page*10))
                                                    <tr>
                                                        ...
                                                        <td class="column8" width="16%">
                                                            <a href="/saticiurunresmisil?id={{ $resim->pictureId }}"><button type="button" class="btn btn-danger btn-sm">{{ __('urunler.sil') }}</button></a>
                                                        </td>
                                                    </tr>
                                                @endif
                                                <?php $count++; ?>
                                            ...
                                            <div class="col-md-12 text-center">
                                                <ul class="pagination pagination-sm justify-content-center ">
                                                    ...
                                                    @while($pagerCount < $totalPager)
                                                        @if($pagerCount == $page)
                                                            <li class="page-item active"><a class="page-link" href="/saticiurunresmiduzenle?page={{ $pagerCount }}">{{ $pagerCount }}</a></li>
                                                        @else
                                                            <li class="page-item"><a class="page-link" href="/saticiurunresmiduzenle?page={{ $pagerCount }}">{{ $pagerCount }}</a></li>
                                                        @endif
                                                        <?php $pagerCount++; ?>
                                                    @endwhile
                                                </ul>
