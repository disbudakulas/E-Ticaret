...
class Upload {
    ...
    /**
     * Type of picture (png, gif, jpg, webp or bmp)
     *
     * @access public
     * @var string
     */
    ...
    /**
     * Destination picture type (png, gif, jpg, webp or bmp)
     *
     * @access public
     * @var integer
     */
    ...
    /**
     * Flag to determine if the source file is an picture
     *
     * @access public
     * @var boolean
     */
     ...
     *
     * If the file is an picture, then the correct extension will be added
    ...
    /**
     * Set this variable to true to resize the file if it is an picture
     *
    ...
    /**
     * Set this variable to convert the file if it is an picture
     *
    ...
    /**
     * Set this variable to the wanted (or maximum/minimum) width for the processed picture, in pixels
     *
    ...
    /**
     * Set this variable to the wanted (or maximum/minimum) height for the processed picture, in pixels
     *
     * Default value is 150
     *
     * @access public
     ...
     * Set this variable to keep the original size ratio to fit within {@link image_x} x {@link image_y}
     *
     * The picture will be resized as to fill the whole space, and excedent will be cropped
     *
     * Value can also be a string, one or more character from 'TBLR' (top, bottom, left and right)
     * If set as a string, it determines which side of the picture is kept while cropping.
     * By default, the part of the picture kept is in the center, i.e. it crops equally on both sides
     *
     * Default value is false
     *
     * @access public
     ...
     * Set this variable to keep the original size ratio to fit within {@link image_x} x {@link image_y}
     *
     * The picture will be resized to fit entirely in the space, and the rest will be colored.
     * The default color is white, but can be set with {@link image_default_color}
     *
     * Value can also be a string, one or more character from 'TBLR' (top, bottom, left and right)
     * If set as a string, it determines in which side of the space the picture is displayed.
     * By default, the picture is displayed in the center, i.e. it fills the remaining space equally on both sides
     *
     * Default value is false
     *
     * @access public
     ...
     *
     * The picture will be resized to have approximatively the number of pixels
     ...
     * but only if original picture is bigger
     *
    ...
    /**
     * (deprecated) Set this variable to keep the original size ratio to fit within {@link image_x} x {@link image_y},
     * but only if original picture is smaller
     *
     * Default value is false
     *
    ...
    /**
     * Cancel resizing if the resized picture is bigger than the original picture, to prevent enlarging
     *
     * Default value is false
     *
     * @access public
    ...
    /**
     * Cancel resizing if the resized picture is smaller than the original picture, to prevent shrinking
     *
     * Default value is false
     *
     * @access public
    ...
    /**
     * Set this variable to set a maximum picture width, above which the upload will be invalid
     *
    ...
    /**
     * Set this variable to set a maximum picture height, above which the upload will be invalid
     *
     * Default value is null
     *
     * @access public
    ...
    /**
     * Set this variable to set a maximum number of pixels for an picture, above which the upload will be invalid
     *
     * Default value is null
     *
     * @access public
    ...
    /**
     * Set this variable to set a maximum picture aspect ratio, above which the upload will be invalid
     *
    ...
    /**
     * Set this variable to set a minimum picture width, below which the upload will be invalid
     *
     * Default value is null
     *
     * @access public
    ...
    /**
     * Set this variable to set a minimum picture height, below which the upload will be invalid
     *
     * Default value is null
     *
     * @access public
    ...
    /**
     * Set this variable to set a minimum number of pixels for an picture, below which the upload will be invalid
     *
     * Default value is null
     *
     * @access public
    ...
    /**
     * Set this variable to set a minimum picture aspect ratio, below which the upload will be invalid
     *
     * Note that ratio = width / height
     *
     * Default value is null
    ...
    /**
     * Quality of JPEG created/converted destination picture
     *
     * Default value is 85
     *
     * @access public
    ...
    /**
     * Quality of WebP created/converted destination picture
     *
     * Default value is 85
     *
     * @access public
    ...
    /**
     * Determines the quality of the JPG picture to fit a desired file size
     *
    ...
    /**
     * Flag set to true when the picture is transparent
     *
     ...
     * This is useful when, from an alpha transparent PNG or WEBP picture, or an picture with alpha transparent features
    ...
    /**
     * Flag set to true when the picture is not true color
     *
     * @access public
     * @var boolean
     */
    ...
    /**
     * Corrects the picture brightness
     *
    ...
    /**
     * Applies a colored overlay on the picture
     *
     * Value is an hexadecimal color, such as #FFFFFF
     *
    ...
    /**
     * Inverts the color of an picture
     *
     * Default value is FALSE
     *
     * @access public
    ...
    /**
     * Turns the picture into greyscale
     *
     * Default value is FALSE
     *
     * @access public
    ...
    /**
     * Adds a text label on the picture
     *
    ...
    /**
     * Sets the text label position within the picture
     *
    ...
    /**
     * Sets the text label absolute X position within the picture
     *
     * Value is in pixels, representing the distance between the left of the picture and the label
     * If a negative value is used, it will represent the distance between the right of the picture and the label
     *
    ...
    /**
     * Sets the text label absolute Y position within the picture
     *
     * Value is in pixels, representing the distance between the top of the picture and the label
     * If a negative value is used, it will represent the distance between the bottom of the picture and the label
     *
     * Default value is null (so {@link image_text_position} is used)
     *
     * @access public
    ...
    /**
     * Sets the space between the source picture and its relection
     *
    ...
    /**
     * Automatically rotates the picture according to EXIF data (JPEG only)
     *
     * Default value is true
     *
     * @access public
    ...
    /**
     * Flips the picture vertically or horizontally
     *
     * Value is either 'h' or 'v', as in horizontal and vertical
     *
    ...
    /**
     * Rotates the picture by increments of 45 degrees
     *
     ...
     * Each value can be in pixels (with or without 'px'), or percentage (of the source picture)
     *
     ...
     * </pre>
     *
     * If a value is negative, the picture will be expanded, and the extra parts will be filled with black
     *
    ...
    /**
     * Crops an picture, before an eventual resizing
     *
    ...
    /**
     * Adds a bevel border on the picture
     *
    ...
    /**
     * Adds a single-color border on the outer of the picture
     *
     * Values are four dimensions, or two, or one (CSS style)
     ...
     * See {@link image_crop} for valid formats
     *
     * If a value is negative, the picture will be cropped.
    ...
    /**
     * Adds a fading-to-transparent border on the picture
     *
     * Values are four dimensions, or two, or one (CSS style)
     * They represent the border thickness top, right, bottom and left.
     * These values can either be in an array, or a space separated string.
    ...
    /**
     * Adds a multi-color frame on the outer of the picture
     *
     ...
     * These values can either be in an array, or a space separated string.
     *
     * The colors are listed in the following order: from the outset of the picture to its center
     *
     * For instance, are valid:
     * <pre>
    ...
    /**
     * Adds a watermark on the picture
     *
     * Value is a local picture filename, relative or absolute. GIF, JPG, BMP, WEBP and PNG are supported, as well as PNG and WEBP alpha.
     *
    ...
    /**
     * Sets the watermarkposition within the picture
     *
     * Value is one or two out of 'TBLR' (top, bottom, left, right)
     *
    ...
    /**
     * Sets the watermark absolute X position within the picture
     *
     * Value is in pixels, representing the distance between the top of the picture and the watermark
     * If a negative value is used, it will represent the distance between the bottom of the picture and the watermark
     *
    ...
    /**
     * Sets the twatermark absolute Y position within the picture
     *
     * Value is in pixels, representing the distance between the left of the picture and the watermark
     * If a negative value is used, it will represent the distance between the right of the picture and the watermark
     *
     * Default value is null (so {@link image_watermark_position} is used)
     *
     * @access public
    ...
    /**
     * Prevents the watermark to be resized up if it is smaller than the picture
     *
     * If the watermark if smaller than the destination picture, taking in account the desired watermark position
     * then it will be resized up to fill in the picture (minus the {@link image_watermark_x} or {@link image_watermark_y} values)
     *
     ...
     * If you want your watermark to be resized up or doan to fill in the picture better, then
    ...
    /**
     * Prevents the watermark to be resized down if it is bigger than the picture
     *
     * If the watermark if bigger than the destination picture, taking in account the desired watermark position
     * then it will be resized down to fit in the picture (minus the {@link image_watermark_x} or {@link image_watermark_y} values)
     *
     * If you don't want your watermark to be resized in any way, then
     * set {@link image_watermark_no_zoom_in} and {@link image_watermark_no_zoom_out} to true
     * If you want your watermark to be resized up or doan to fill in the picture better, then
     * set {@link image_watermark_no_zoom_in} and {@link image_watermark_no_zoom_out} to false
     *
     * Default value is false (so the watermark may be shrinked to fit in the picture)
     *
     * @access public
     * @var integer
     */
     ...
     *
     * Simple wildcards are allowed, such as picture/* or application/*
    ...
    function init() {
        ...
        $this->image_resize             = false;    // resize the picture
        ...
        $this->image_ratio_fill         = false;    // keeps aspect ratio within x and y dimensions, fitting the picture in the space
        ...
        $this->allowed = array(
            ...
            'application/vnd.oasis.opendocument.picture',
        ...
        $this->mime_types = array(
            ...
            'odi' => 'application/vnd.oasis.opendocument.picture',
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->translation['ratio_too_high']              = 'Image ratio too high (picture too wide).';
        $this->translation['ratio_too_low']               = 'Image ratio too low (picture too high).';
        ...
        $this->translation['create_error']                = 'Error in creating %s picture from source.';
        $this->translation['source_invalid']              = 'Can\'t read picture source. Not an picture?.';
        ...
        $this->translation['watermark_invalid']           = 'Unknown picture format, can\'t read watermark.';
        ...
        // determines the supported MIME types, and matching picture format
        $this->image_supported = array();
        if ($this->gdversion()) {
            if (imagetypes() & IMG_GIF) {
                $this->image_supported['picture/gif'] = 'gif';
            }
            if (imagetypes() & IMG_JPG) {
                $this->image_supported['picture/jpg'] = 'jpg';
                $this->image_supported['picture/jpeg'] = 'jpg';
                $this->image_supported['picture/pjpeg'] = 'jpg';
            }
            if (imagetypes() & IMG_PNG) {
                $this->image_supported['picture/png'] = 'png';
                $this->image_supported['picture/x-png'] = 'png';
            }
            if (imagetypes() & IMG_WEBP) {
                $this->image_supported['picture/webp'] = 'webp';
                $this->image_supported['picture/x-webp'] = 'webp';
            }
            if (imagetypes() & IMG_WBMP) {
                $this->image_supported['picture/bmp'] = 'bmp';
                $this->image_supported['picture/x-ms-bmp'] = 'bmp';
                $this->image_supported['picture/x-windows-bmp'] = 'bmp';
            }
        }
        ...
        if (empty($this->log)) {
            ...
            $this->log .= '-&nbsp;supported picture types   : ' . (!empty($supported) ? $supported : 'none') . '<br />';
        ...
        if ($this->uploaded) {
                ...
                if ($this->mime_getimagesize) {
                    ...
                    if (is_array($info) && array_key_exists('mime', $info)) {
                        ...
                        if (empty($this->file_src_mime)) {
                            ...
                            $this->file_src_mime = ($mime==IMAGETYPE_GIF  ? 'picture/gif' :
                                                   ($mime==IMAGETYPE_JPEG ? 'picture/jpeg' :
                                                   ($mime==IMAGETYPE_PNG  ? 'picture/png' :
                                                   ($mime==IMAGETYPE_WEBP  ? 'picture/webp' :
                                                   ($mime==IMAGETYPE_BMP  ? 'picture/bmp' : null)))));
                        }
            ...
            // determine whether the file is an picture
            ...
            // if the file is an picture, we gather some useful data
            if ($this->file_is_image) {
                if ($h = fopen($this->file_src_pathname, 'r')) {
                    ...
                    if (is_array($info)) {
                        ...
                        $this->file_is_image = false;
                        $this->uploaded = false;
                        $this->log .= '- can\'t retrieve picture information, picture may have been tampered with<br />';
                        $this->error = $this->translate('source_invalid');
                    }
                } else {
            ...
            if ($this->file_is_image) {
                $this->log .= '- source file is an picture<br />';
    ...
    function imagecreatenew($x, $y, $fill = true, $trsp = false) {
        ...
        if ($this->gdversion() >= 2 && !$this->image_is_palette) {
            ...
            // creates a palette picture
            $dst_im = imagecreate($x, $y);
            // preserves transparency for palette images, if the original picture has transparency
    ...
    /**
     * Transfers an picture from the container to the destination picture
     *
     * @access private
     * @param  resource $src_im Container picture
     * @param  resource $dst_im Destination picture
     * @return resource Destination picture
     */
     ...
     *
     * @access private
     * @param  resource $dst_img Destination picture
     * @param  resource $src_img Overlay picture
     ...
     * for instance to create a resized picture and a thumbnail of the same file.
     ...
     * and if it is an picture, can be resized or converted.
     *
     ...
     * @return string Optional content of the picture
     */
    function process($server_path = null) {
        ...
        if ($this->processed) {
            // if we have an picture without extension, set it
            ...
            // if the file is an picture, we can check on its dimensions
            ...
            if ($this->file_is_image) {
                if (is_numeric($this->image_src_x) && is_numeric($this->image_src_y)) {
                    ...
                    $this->log .= '- no picture properties available, can\'t enforce dimension checks : ' . $this->file_src_mime . '<br />';
                }
            }
        }
        ...
        if ($this->processed) {
            ...
            if ($this->image_convert && $this->file_is_image) { // if we convert as an picture
        ...
        if ($this->processed) {
            ...
            // check if we need to autorotate, to automatically pre-rotates the picture according to EXIF data (JPEG only)
            $auto_flip = false;
            $auto_rotate = 0;
            ...
            // do we do some picture manipulation?
            ...
            // we do a quick check to ensure the file is really an picture
            ...
            if ($image_manipulation && !@getimagesize($this->file_src_pathname)) {
                $this->log .= '- the file is not an picture!<br />';
            ...
            if ($image_manipulation) {
                ...
                // we now do all the picture manipulations
                $this->log .= '- picture resizing or conversion wanted<br />';
                if ($this->gdversion()) {
                        ...
                        case 'jpg':
                            if (!$this->function_enabled('imagecreatefromjpeg')) {
                                ...
                                if (!$image_src) {
                                    ...
                                    $this->log .= '- source picture is JPEG<br />';
                                }
                            }
                            break;
                        case 'png':
                            if (!$this->function_enabled('imagecreatefrompng')) {
                                ...
                                if (!$image_src) {
                                    ...
                                    $this->log .= '- source picture is PNG<br />';
                                }
                            }
                            break;
                        case 'webp':
                            if (!$this->function_enabled('imagecreatefromwebp')) {
                                ...
                                if (!$image_src) {
                                    ...
                                    $this->log .= '- source picture is WEBP<br />';
                                }
                            }
                            break;
                        case 'gif':
                            if (!$this->function_enabled('imagecreatefromgif')) {
                                ...
                                if (!$image_src) {
                                    ...
                                    $this->log .= '- source picture is GIF<br />';
                                }
                            }
                            break;
                        case 'bmp':
                            if (!method_exists($this, 'imagecreatefrombmp')) {
                                ...
                                if (!$image_src) {
                                    ...
                                    $this->log .= '- source picture is BMP<br />';
                                }
                            }
                            break;
                        default:
                ...
                if ($this->processed && $image_src) {
                    ...
                    if (!imageistruecolor($image_src)) {  // $this->image_src_type == 'gif'
                        $this->log .= '- picture is detected as having a palette<br />';
                        ...
                        if ($this->image_transparent_color >= 0 && imagecolorstotal($image_src) > $this->image_transparent_color) {
                            ...
                            $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;palette picture is detected as transparent<br />';
                        }
                        // if the picture has a palette (GIF), we convert it to true color, preserving transparency
                        $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;convert palette picture to true color<br />';
                    ...
                    // auto-flip picture, according to EXIF data (JPEG only)
                    if ($gd_version >= 2 && !empty($auto_flip)) {
                        $this->log .= '- auto-flip picture : ' . ($auto_flip == 'v' ? 'vertical' : 'horizontal') . '<br />';
                    ...
                    // auto-rotate picture, according to EXIF data (JPEG only)
                    if ($gd_version >= 2 && is_numeric($auto_rotate)) {
                        ...
                        if ($auto_rotate != 0) {
                            ...
                            $this->log .= '- auto-rotate picture : ' . $auto_rotate . '<br />';
                            for ($x = 0; $x < $this->image_src_x; $x++) {
                                for ($y = 0; $y < $this->image_src_y; $y++){
                                    if ($auto_rotate == 90) {
                    ...
                    // pre-crop picture, before resizing
                    if ((!empty($this->image_precrop))) {
                        ...
                        $this->log .= '- pre-crop picture : ' . $ct . ' ' . $cr . ' ' . $cb . ' ' . $cl . ' <br />';
                        ...
                        // we copy the picture into the recieving picture
                    ...
                    // resize picture (and move image_src_x, image_src_y dimensions into image_dst_x, image_dst_y)
                    if ($this->image_resize) {
                        ...
                        // keeps aspect ratio, calculating x and y so that the picture is approx the set number of pixels
                        ...
                        // keeps aspect ratio with x and y dimensions, fitting the picture in the space, and coloring the rest
                        ...
                        // make sure we don't enlarge the picture if we don't want to
                        if ($this->image_no_enlarging && ($this->image_src_x < $this->image_dst_x || $this->image_src_y < $this->image_dst_y)) {
                            $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;cancel resizing, as it would enlarge the picture!<br />';
                            $this->image_dst_x = $this->image_src_x;
                            $this->image_dst_y = $this->image_src_y;
                            $ratio_crop = null;
                        }

                        // make sure we don't shrink the picture if we don't want to
                        if ($this->image_no_shrinking && ($this->image_src_x > $this->image_dst_x || $this->image_src_y > $this->image_dst_y)) {
                            $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;cancel resizing, as it would shrink the picture!<br />';
                            $this->image_dst_x = $this->image_src_x;
                            $this->image_dst_y = $this->image_src_y;
                            $ratio_crop = null;
                        }
                        ...
                        if ($this->image_dst_x != $this->image_src_x || $this->image_dst_y != $this->image_src_y) {
                            ...
                            $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;resized picture object created<br />';
                             // we transfert tmp into image_dst
                            $image_dst = $this->imagetransfer($tmp, $image_dst);
                        }
                    ...
                    // crop picture (and also crops if image_ratio_crop is used)
                    if ((!empty($this->image_crop) || !is_null($ratio_crop))) {
                        ...
                        if ($ct != 0 || $cr != 0 || $cb != 0 || $cl != 0) {
                            $this->log .= '- crop picture : ' . $ct . ' ' . $cr . ' ' . $cb . ' ' . $cl . ' <br />';
                    ...
                    if ($gd_version >= 2 && !empty($this->image_flip)) {
                        ...
                        $this->log .= '- flip picture : ' . $this->image_flip . '<br />';
                        $tmp = $this->imagecreatenew($this->image_dst_x, $this->image_dst_y);
                    ...
                    if ($gd_version >= 2 && is_numeric($this->image_rotate)) {
                        ...
                        if ($this->image_rotate != 0) {
                            ...
                            $this->log .= '- rotate picture : ' . $this->image_rotate . '<br />';
                            for ($x = 0; $x < $this->image_dst_x; $x++) {
                                for ($y = 0; $y < $this->image_dst_y; $y++){
                    ...
                    if ((is_numeric($this->image_pixelate) && $this->image_pixelate > 0)) {
                        $this->log .= '- pixelate picture (' . $this->image_pixelate . 'px)<br />';
                    ...
                    if ($gd_version >= 2 && !empty($this->image_border)) {
                        ...
                        // we now create an picture, that we fill with the border color
                        $tmp = $this->imagecreatenew($this->image_dst_x, $this->image_dst_y);
                        ...
                        // we then copy the source picture into the new picture, without merging so that only the border is actually kept
                    ...
                    if ($gd_version >= 2 && !empty($this->image_border_transparent)) {
                        ...
                        // we now create an picture, that we fill with the border color
                        $tmp = $this->imagecreatenew($this->image_dst_x, $this->image_dst_y);
                        // we then copy the source picture into the new picture, without the borders
                        ...
                        if ($watermark_type == IMAGETYPE_GIF) {
                            if (!$this->function_enabled('imagecreatefromgif')) {
                                ...
                                if (!$filter) {
                                    ...
                                    $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;watermark source picture is GIF<br />';
                            ...
                            if (!$this->function_enabled('imagecreatefromjpeg')) {
                                ...
                                if (!$filter) {
                                    ...
                                    $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;watermark source picture is JPEG<br />';
                                    $watermark_checked = true;
                                }
                            }
                            ...
                            if (!$this->function_enabled('imagecreatefrompng')) {
                                ...
                                if (!$filter) {
                                    ...
                                    $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;watermark source picture is PNG<br />';
                                    $watermark_checked = true;
                                }
                            }
                            ...
                            if (!$this->function_enabled('imagecreatefromwebp')) {
                                ...
                                if (!$filter) {
                                    ...
                                    $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;watermark source picture is WEBP<br />';
                                    $watermark_checked = true;
                                }
                            }
                            ...
                            if (!method_exists($this, 'imagecreatefrombmp')) {
                                ...
                                if (!$filter) {
                                    ...
                                    $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;watermark source picture is BMP<br />';
                                    $watermark_checked = true;
                                }
                            }
                        } else {
                    ...
                    if ($this->image_reflection_height) {
                        ...
                        // create the new destination picture
                        ...
                        // copy the resulting picture into the destination picture
                    ...
                    // reduce the JPEG picture to a set desired size
                    if (is_numeric($this->jpeg_size) && $this->jpeg_size > 0 && ($this->image_convert == 'jpeg' || $this->image_convert == 'jpg')) {
                        ...
                        // calculate size of each picture. 75%, 50%, and 25% quality
                    ...
                    // converts picture from true color, and fix transparency if needed
                    $this->log .= '- converting...<br />';
                    $this->image_dst_type = $this->image_convert;
                    switch($this->image_convert) {
                        case 'gif':
                            // if the picture is true color, we convert it to a palette
                            if (imageistruecolor($image_dst)) {
                                ...
                                // first, we merge the picture with the background color, so we know which colors we will have
                                for ($x = 0; $x < $this->image_dst_x; $x++) {
                                    for ($y = 0; $y < $this->image_dst_y; $y++) {
                                        if ($mask[$x][$y] > 0){
                                ...
                                // transforms the true color picture into palette, with its merged default color
                                if (empty($this->image_background_color)) {
                        ...
                        case 'jpg':
                        case 'bmp':
                            // if the picture doesn't support any transparency, then we merge it with the default color
                    ...
                    switch($this->image_convert) {
                        ...
                        case 'jpg':
                            ...
                            if (!$result) {
                                ...
                                $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;JPEG picture created<br />';
                            }
                            break;
                        case 'png':
                            ...
                            if (!$result) {
                                ...
                                $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;PNG picture created<br />';
                            }
                            break;
                        case 'webp':
                            imagealphablending( $image_dst, false );
                            ...
                            if (!$result) {
                                ...
                                $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;WEBP picture created<br />';
                            }
                            break;
                        case 'gif':
                            if (!$return_mode) {
                            ...
                            if (!$result) {
                                ...
                                $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;GIF picture created<br />';
                            }
                            break;
                        case 'bmp':
                            if (!$return_mode) {
                            ...
                            if (!$result) {
                                ...
                                $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;BMP picture created<br />';
                            }
                            break;
                    ...
                    if ($this->processed) {
                        ...
                        $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;picture objects destroyed<br />';
                    }
                }

            } else {
                $this->log .= '- no picture processing wanted<br />';
        ...
        // we may return the picture content
    ...
    function imagebmp(&$im, $filename = "") {
        ...
        // if the picture is not true color, we convert it first
