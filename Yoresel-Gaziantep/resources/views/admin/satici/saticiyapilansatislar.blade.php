                                    ...
                                    @if(isset($siparisler) and $siparisler)
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <th class="column4">{{ __('saticisiparisler.durum') }}</th>
                                                <th class="column8"></th>
                                            </tr>
                                            </thead>
                                            <tbody>
                    ...
                    <div class="modal-body" style="padding-left: 35px;padding-right: 35px">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="order-detail-container">
                                        <label class="order-detail-title">{{ __('saticisiparisler.aliciadres') }}</label>
                                        <label class="order-detail-text" id="kargoadi"></label>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="order-detail-container">
                                        <label class="order-detail-title">{{ __('saticisiparisler.alicitel') }}</label>
                                        <label class="order-detail-text" id="takipno"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    function orderDetail(val) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#kargoadi').text(data['kargoadi']);
                $('#takipno').text(data['takipno']);
